<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Mid-Year.aspx.cs" Inherits="BSP.Mid_Year" %>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
							...
							<asp:GridView ID="gvMidYear" runat="server" AutoGenerateColumns="False" Width="1010px" CssClass="gridviewSize" AllowPaging="True" ShowFooter="True" OnRowCommand="gvMidYear_RowCommand">
                                                   <Columns>
                                            ...
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lnkInvoiceView3" runat="server" CommandName="UpdategvMidYear"
...
<ItemStyle HorizontalAlign="Center" Width="80px"></ItemStyle>
                                        ...
                                        <table runat="server" id="tblMidYear" visible ="false">
                                            ...
                                            <tr>
                                                <td class="auto-style1"><asp:Label ID="lblIDPDate9" runat="server" Text="Annual Target" CssClass="labelstyle"></asp:Label></td>
                                                <td class="Topcolumn1"> <asp:TextBox ID="txtAnnualTarget" runat="server"  CssClass="textboxstyle" Enabled="False"></asp:TextBox></td>
                                                <td class="Topcolumn1">&nbsp;</td>
                                            </tr>
                                            
    
                                            <tr>
                                                <td class="auto-style2"><asp:Label ID="lblIDPDate10" runat="server" Text="Annual Progress" CssClass="labelstyle"></asp:Label></td>
                                                <td class="auto-style3"> 
                                                    <asp:DropDownList ID="ddlAnnualProgress" runat="server" CssClass="dropdownstyle">
                                            ...
                                            <tr>
                                                <td class="auto-style2"><asp:Label ID="lblIDPDate18" runat="server" Text="Remedial Action/Intervention" CssClass="labelstyle"></asp:Label></td>
                                                <td class="auto-style3"> <asp:TextBox ID="txtRemedialAction" runat="server"  CssClass="textboxstyle" TextMode="MultiLine"></asp:TextBox></td>
                                                <td class="auto-style3"></td>
                                            </tr>
