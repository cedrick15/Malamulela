<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Quarterly.aspx.cs" Inherits="BSP.Quarterly" %>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i>Organizational Per Reports</a>
                            <ul class="nav nav-second-level">
                                <li>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                    &nbsp;&nbsp;&nbsp;
                                    <asp:Label ID="lblANALYSISPHASE" runat="server" Text="Quarter 1"></asp:Label>
                                    </div>
							<asp:GridView ID="gvQuarter1" runat="server" AutoGenerateColumns="False" Width="1010px" CssClass="gridviewSize" AllowPaging="True" ShowFooter="True" OnRowCommand="gvQuarter1_RowCommand">
                                                   <Columns>
                                            ...
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lnkInvoiceView3" runat="server" CommandName="UpdategvQ1"
...
<ItemStyle HorizontalAlign="Center" Width="80px"></ItemStyle>
							...
							<br />
							<asp:Label ID="lblANALYSISPHASE0" runat="server" Text="Quarter 2"></asp:Label>

							<asp:GridView ID="gvQuarter2" runat="server" AutoGenerateColumns="False" Width="1010px" CssClass="gridviewSize" AllowPaging="True" ShowFooter="True" OnRowCommand="gvQuarter2_RowCommand">
                                                   <Columns>
													   <asp:BoundField DataField="ProjectName" HeaderText="Project Name" />
													   <asp:BoundField DataField="DevelopmentObjective" HeaderText="Development Objective" />
													   <asp:BoundField DataField="KeyPerformanceIndicatorsMeasurableObjective" HeaderText="Key Performance Indicators" />
													   ...
													   <asp:BoundField DataField="EndDate" HeaderText="End Date" />
													      <asp:TemplateField HeaderText="Update" ItemStyle-Width="80px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lnkInvoiceView3" runat="server" CommandName="UpdategvQ2"
                                                    ForeColor="#339933">Update</asp:LinkButton>
                                            </ItemTemplate>
...
<ItemStyle HorizontalAlign="Center" Width="80px"></ItemStyle>
							...
							<br />
							<asp:Label ID="lblANALYSISPHASE1" runat="server" Text="Quarter 3"></asp:Label>

							<asp:GridView ID="gvQuarter3" runat="server" AutoGenerateColumns="False" Width="1010px" CssClass="gridviewSize" AllowPaging="True" ShowFooter="True" OnRowCommand="gvQuarter3_RowCommand">
                                                   <Columns>
													   <asp:BoundField DataField="ProjectName" HeaderText="Project Name" />
													   <asp:BoundField DataField="DevelopmentObjective" HeaderText="Development Objective" />
													   <asp:BoundField DataField="KeyPerformanceIndicatorsMeasurableObjective" HeaderText="Key Performance Indicators" />
													   ...
													   <asp:BoundField DataField="EndDate" HeaderText="End Date" />
													      <asp:TemplateField HeaderText="Update" ItemStyle-Width="80px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lnkInvoiceView3" runat="server" CommandName="UpdategvQ3"
                                                    ForeColor="#339933">Update</asp:LinkButton>
                                            </ItemTemplate>
...
<ItemStyle HorizontalAlign="Center" Width="80px"></ItemStyle>
							...
							<br />
							<asp:Label ID="lblANALYSISPHASE2" runat="server" Text="Quarter 4"></asp:Label>

							<asp:GridView ID="gvQuarter4" runat="server" AutoGenerateColumns="False" Width="1010px" CssClass="gridviewSize" AllowPaging="True" ShowFooter="True" OnRowCommand="gvQuarter4_RowCommand">
                                                   <Columns>
													   <asp:BoundField DataField="ProjectName" HeaderText="Project Name" />
													   <asp:BoundField DataField="DevelopmentObjective" HeaderText="Development Objective" />
													   <asp:BoundField DataField="KeyPerformanceIndicatorsMeasurableObjective" HeaderText="Key Performance Indicators" />
													   ...
													   <asp:BoundField DataField="EndDate" HeaderText="End Date" />
													      <asp:TemplateField HeaderText="Update" ItemStyle-Width="80px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lnkInvoiceView3" runat="server" CommandName="UpdategvQ4"
                                                    ForeColor="#339933">Update</asp:LinkButton>
                                            </ItemTemplate>
...
<ItemStyle HorizontalAlign="Center" Width="80px"></ItemStyle>
                                        ...
                                        <table runat="server" id="tblQuarterly" visible ="false">
                                            ...
                                            <tr>
                                                <td class="auto-style1"><asp:Label ID="lblIDPDate9" runat="server" Text="Q1 Target" CssClass="labelstyle"></asp:Label></td>
                                                <td class="Topcolumn1"> <asp:TextBox ID="txtQ1Target" runat="server"  CssClass="textboxstyle" Enabled="False"></asp:TextBox></td>
                                                <td class="Topcolumn1">&nbsp;</td>
                                            </tr>
                                            
    
                                            <tr>
                                                <td class="auto-style1"><asp:Label ID="lblIDPDate10" runat="server" Text="Q1 Progress" CssClass="labelstyle"></asp:Label></td>
                                                <td class="Topcolumn1"> 
                                                    <asp:DropDownList ID="ddlQ1Progress" runat="server" CssClass="dropdownstyle">
                                            ...
                                            <tr>
                                                <td class="auto-style1"><asp:Label ID="lblIDPDate11" runat="server" Text="Q2 Target" CssClass="labelstyle"></asp:Label></td>
                                                <td class="Topcolumn1"> <asp:TextBox ID="txtQ2Target" runat="server"  CssClass="textboxstyle" Enabled="False"></asp:TextBox></td>
                                                <td class="Topcolumn1">&nbsp;</td>
                                            </tr>
                                            
    
                                            <tr>
                                                <td class="auto-style1"><asp:Label ID="lblIDPDate12" runat="server" Text="Q2 Progress" CssClass="labelstyle"></asp:Label></td>
                                                <td class="Topcolumn1"> 
                                                    <asp:DropDownList ID="ddlQ2Progress" runat="server" CssClass="dropdownstyle">
                                                        <asp:ListItem>Please Select...</asp:ListItem>
                                                        <asp:ListItem>Not Achieved</asp:ListItem>
                                                        <asp:ListItem>Achieved</asp:ListItem>
                                                    </asp:DropDownList>
                                            ...
                                            <tr>
                                                <td class="auto-style1"><asp:Label ID="lblIDPDate13" runat="server" Text="Q3 Target" CssClass="labelstyle"></asp:Label></td>
                                                <td class="Topcolumn1"> <asp:TextBox ID="txtQ3Target" runat="server"  CssClass="textboxstyle" Enabled="False"></asp:TextBox></td>
                                                <td class="Topcolumn1">&nbsp;</td>
                                            </tr>
                                            
    
                                            <tr>
                                                <td class="auto-style1"><asp:Label ID="lblIDPDate14" runat="server" Text="Q3 Progress" CssClass="labelstyle"></asp:Label></td>
                                                <td class="Topcolumn1"> 
                                                    <asp:DropDownList ID="ddlQ3Progress" runat="server" CssClass="dropdownstyle">
                                                        <asp:ListItem>Please Select...</asp:ListItem>
                                                        <asp:ListItem>Not Achieved</asp:ListItem>
                                                        <asp:ListItem>Achieved</asp:ListItem>
                                                    </asp:DropDownList>
                                            ...
                                            <tr>
                                                <td class="auto-style1"><asp:Label ID="lblIDPDate15" runat="server" Text="Q4 Target" CssClass="labelstyle"></asp:Label></td>
                                                <td class="Topcolumn1"> <asp:TextBox ID="txtQ4Target" runat="server"  CssClass="textboxstyle" Enabled="False"></asp:TextBox></td>
                                                <td class="Topcolumn1">&nbsp;</td>
                                            </tr>
                                            
    
                                            <tr>
                                                <td class="auto-style1"><asp:Label ID="lblIDPDate16" runat="server" Text="Q4 Progress" CssClass="labelstyle"></asp:Label></td>
                                                <td class="Topcolumn1"> 
                                                    <asp:DropDownList ID="ddlQ4Progress" runat="server" CssClass="dropdownstyle">
                                                        <asp:ListItem>Please Select...</asp:ListItem>
                                                        <asp:ListItem>Not Achieved</asp:ListItem>
                                                        <asp:ListItem>Achieved</asp:ListItem>
                                                    </asp:DropDownList>
